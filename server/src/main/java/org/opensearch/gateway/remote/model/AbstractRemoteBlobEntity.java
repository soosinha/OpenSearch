...
/**
 * An extension of {@link RemoteEntity} class which caters to the use case of writing to and reading from a blob storage
 *
 * @param <T> The class type which can be uploaded to or downloaded from a blob storage.
 */
public abstract class AbstractRemoteBlobEntity<T> implements RemoteEntity<T> {
    ...
    public AbstractRemoteBlobEntity(final BlobStoreRepository blobStoreRepository, final String clusterUUID) {
