...
public class ExplainActionIT extends OpenSearchIntegTestCase {
    public void testSimple() throws Exception {
        ...
        ExplainResponse response = client().prepareExplain(indexOrAlias(), "1").setPreference("_primary").setQuery(QueryBuilders.matchAllQuery()).get();
        ...
        refresh();
        response = client().prepareExplain(indexOrAlias(), "1").setPreference("_primary").setQuery(QueryBuilders.matchAllQuery()).get();
        assertNotNull(response);
        ...
        response = client().prepareExplain(indexOrAlias(), "1").setPreference("_primary").setQuery(QueryBuilders.termQuery("field", "value2")).get();
        assertNotNull(response);
        ...
        response = client().prepareExplain(indexOrAlias(), "1").setPreference("_primary")
            .setQuery(
        ...
        response = client().prepareExplain(indexOrAlias(), "2").setPreference("_primary").setQuery(QueryBuilders.matchAllQuery()).get();
        assertNotNull(response);
    ...
    public void testExplainWithFields() throws Exception {
        ...
        refresh();
        ExplainResponse response = client().prepareExplain(indexOrAlias(), "1").setPreference("_primary")
    ...
    public void testExplainWithFilteredAlias() {
        ...
        ExplainResponse response = client().prepareExplain("alias1", "1").setPreference("_primary").setQuery(QueryBuilders.matchAllQuery()).get();
        assertNotNull(response);
        assertTrue(response.isExists());
        assertFalse(response.isMatch());
    }
    ...
    public void testExplainWithFilteredAliasFetchSource() throws Exception {
        ...
        ExplainResponse response = client().prepareExplain("alias1", "1").setPreference("_primary")
            .setQuery(QueryBuilders.matchAllQuery())
            .setFetchSource(true)
            .get();
    ...
    public void testExplainDateRangeInQueryString() {
        ...
        ExplainResponse explainResponse = client().prepareExplain("test", "1").setPreference("_primary").setQuery(queryStringQuery("past:[now-2M/d TO now/d]")).get();
